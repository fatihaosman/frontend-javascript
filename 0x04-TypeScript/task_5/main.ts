// 1. Define interface for MajorCredits
interface MajorCredits {
  credits: number;
  brand: 'major'; // brand property to uniquely identify
}

// 2. Define interface for MinorCredits
interface MinorCredits {
  credits: number;
  brand: 'minor'; // brand property to uniquely identify
}
